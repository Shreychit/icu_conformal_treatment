...
def create_simple_dataset() -> None:
    ...
    print(f"Simple dataset: train={train_df.shape}, val={val_df.shape}, test={test_df.shape}")
...
def create_causal_dataset() -> None:
    ...
    print(f"Causal dataset: train={train_df.shape}, calib={calib_df.shape}, test={test_df.shape}")
