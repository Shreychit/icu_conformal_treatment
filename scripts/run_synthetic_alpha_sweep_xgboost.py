...
def run_synthetic_alpha_sweep_xgb(
    alphas=None,
    ...
    out_path = "data/processed/synth_conformal_alpha_sweep_xgboost.parquet"
    df.to_parquet(out_path, index=False)
    print(df)
    print(f"Saved synthetic XGBoost alpha sweep to {out_path}")
    return df


if __name__ == "__main__":
    run_synthetic_alpha_sweep_xgb()
